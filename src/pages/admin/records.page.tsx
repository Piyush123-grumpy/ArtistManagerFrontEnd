...
const Page = (props) => {
    return (
        <div className="my-3xl my-2 text-white">
            <div className="mt-12">
                <div className="flex">
                    <p className="font-bold px-4">Create Records</p>
                    <RecordModalCrud label={'Create'} type={'Records'} icon={AddIcon} />
                        ...
                        <tbody className="">
                            <tr className="bg-[#121212] text-white dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td className="px-6 py-4 flex">
                                    <div>
                                        <RecordModalCrud label={'Edit'} type={'Records'} icon={EditIcon} />
                                    </div>
                                    <div>
                            ...
                            <tr className="bg-[#121212] dark:bg-gray-800 text-white dark:border-gray-700">
                                <th scope="row" className="px-6 py-4 font-medium  dark:text-white">
                            ...
                            <tr className="bg-[#121212] dark:bg-gray-800 text-white">
